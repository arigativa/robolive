...
import Control.{AgentListRequest, AgentListResponse, RestartRobotRequest, RestartRobotResponse}
...
final class ControlHandler(
  ...
  override def robotsList(request: AgentListRequest): Future[AgentListResponse] = {
    Future {
